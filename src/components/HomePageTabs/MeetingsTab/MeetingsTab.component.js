...
const MeetingsTab = () => {
    ...
    useEffect(() => {
        get(child(ref(firebasedatabase), "BLOCK_WISE_DATA/Bagli")).then((snap)=>{
            alert(snap.size)
        })
    }, [])
                        ...
                        <div className="title-date-container">
                            ...
                            <div className="date-view-container">
                                <div className="icon-info-container">
                                    ...
                                    <p style={{fontWeight:500, color:"#ccc"}}>26.08.2022</p>
                                </div>
                                <div className="icon-info-container">
                                    <img src={viewers} style={{width:15, height:15, marginRight:5}} />
                                    <p style={{fontWeight:500, color:"#ccc"}}>200 viewers</p>
                                </div>
                            </div>
                        </div>
